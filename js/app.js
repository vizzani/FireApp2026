...
(function injectStyles() {
  ...
  s.textContent = `
    ...
    .btn-lavora:hover { background: var(--green-mid, #0d6040); transform: translateY(-1px); }
    .btn-lavora:active { transform: scale(.97); }
    .btn-lavora-sm {
      padding: 6px 12px;
      font-size: 12px;
      margin-top: 6px;
...
el('user-badge')?.addEventListener('click', () => {
  ...
  showModal(`
    ...
    <button class="btn-secondary" style="width:100%;margin-bottom:8px" onclick="closeModal();showPasswordUpdateModal()">Cambia password</button>
